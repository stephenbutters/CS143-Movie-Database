...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <form class="form-horizontal" action="addMARelation.php">
        ...
        <div class="form-group">
          <label class="col-sm-2 control-label" for="actor">Actor</label>
          <div class="col-sm-10">
            <select class="form-control" name="actor">
              <?php
                ...
                mysql_select_db("CS143", $db_connection);
                $rs = mysql_query("SELECT id, last, first, dob FROM Actor;", $db_connection);
                if(!$rs){
                  echo "Query failed: " . mysql_error();
                }
                while($row = mysql_fetch_row($rs)){
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10"><input type="text" class="form-control" name="role" placeholder="Text input"></div>
        </div>
        <div class="form-group">
